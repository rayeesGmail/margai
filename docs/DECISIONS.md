...
- 2026-09-03 · D2 · No Flyway migration at D2; the empty `db/migration` location carries a README so Flyway's location check passes · PLAN D4 owns the first migrations, which overrides the DEV_SPEC §13.8 bootstrap wording · D4.
