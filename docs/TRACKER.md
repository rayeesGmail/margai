...
THE SWEEP THE CHECK CANNOT DO — every first-line indent in the book derived independently and tested
  ...
  ("where m_i is the mass…"). **The last two are named by no flag in any report**: the start check
  under-reports printed starts as well as over-reporting them. And the reverse rule — flush after a
