...
spec-auditor (branch diff + the uncommitted doc notes): FAIL — 3 MAJOR, 8 MINOR. [MAJOR] the
  ...
  row, and the PARTIAL argument is surfaced at the close for the founder to flip. [MAJOR] the
