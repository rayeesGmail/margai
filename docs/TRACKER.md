...
RE-AUDIT: FAIL again, on one MAJOR and seven MINORs — the BLOCKER and the four MAJORs confirmed fixed.
  ...
  what a sum or difference, an exponent or a function covers. **Consequence, for the founder to confirm:
