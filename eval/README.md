...
AI-touching paths (`server/src/main/resources/prompts/`, `server/**/ai/**`, anything named
router/routing/retriev*, `eval/fixtures/*.json`). `scripts/precommit-gate.sh` refuses to commit a
