...
- ch 7 p7: 10 rows start here, the print starts 10 paragraphs — rows the print does not start: §7.6 ¶4 "For h/R_E << 1, using binomial expression," · printed starts no row begins with: "For , using binomial expression,"
...
|---|---|---|---|---|---|---|---|---|
| 7 | 106 | 76 | 74 | 2 | 0 | 0 | 1 | — (30 rows without a verdict) |
clean for the book (PLAN D15 ✅): not computed — some rows have no verdict yet
not in the clean share, adjudicate before recording it: 6 page-level start flags, 0 passages no row carries
