...
verifier: claude-sonnet-5 (prompt ncert_verify.v1); transcribed by: claude-opus-5 (892 rows)
request id: pipeline-ncert-verify-91e3d81f-ea01-4326-b041-20a09ff06815
...
|---|---|---|---|---|---|
| 96 | 431409 | 27314 | 696096 | 7251 | ₹116.88 |
...
- ch 1 p4 §1.3 ¶21: printed "s = 2πr" · transcribed "s = 2 pi r"
- ch 1 p6 §1.3.3 ¶2: printed "l b = 163.62 cm^2 + 1.6%" · transcribed "l b = 163.62 cm^2 ± 1.6%"
- ch 1 p6 §1.3.3 ¶2: printed "= 163.62 + 2.6 cm^2" · transcribed "= 163.62 ± 2.6 cm^2"
- ch 1 p6 §1.3.3 ¶3: printed "l b = 164 + 3 cm^2" · transcribed "l b = 164 ± 3 cm^2"
- ch 3 p3 §3.4 ¶1: printed "section 3.4" · transcribed "section 4.2"
- ch 3 p6 §3.5 ¶4: printed "lambda = A n_hat" · transcribed "lambda = lambda n_hat"
- ch 3 p8 §3.6 ¶11: printed "v_b^2 + v_c^2" · transcribed "v_b^2 + v_b^2"
- ch 4 p7 §4.5 ¶26: printed "Force  time duration" · transcribed "Force × time duration"
- ch 4 p9 §4.6 ¶11: printed "inclined at 30 to the normal" · transcribed "inclined at 30° to the normal"
- ch 5 p7 §5.6 ¶3: printed "speed v_r of the block" · transcribed "speed v_f of the block"
- ch 5 p9 §5.8 ¶8: printed "E_0 = mv_f^2" · transcribed "E_0 = (1/2) mv_f^2"
- ch 5 p13 §5.11 ¶2: printed "speed v_1i" · transcribed "speed v_1i,"
- ch 5 p15 §5.11.3 ¶4: printed "theta_2 = 37" · transcribed "theta_2 = 37°"
- ch 6 p12 §6.5 ¶24: printed "(a_y b_z − a_z b_y) i_hat + (a_z b_x − a_x b_z) j_hat + (a_x b_y − a_y b_x) k_hat" · transcribed "(a_y b_z − a_z b_y) i + (a_z b_x − a_x b_z) j + (a_x b_y − a_y b_x) k"
- ch 6 p12 §6.5 ¶27: printed "−4 j_hat + 5 k_hat)·(−2 i_hat + j_hat + 3 k_hat)" · transcribed "−4 j_hat + 5 k_hat)·(−2 i_hat + j_hat − 3 k_hat)"
- ch 6 p16 §6.7.2 ¶11: printed "p_i = (m_i v_i)" · transcribed "p = (m_i v_i)"
- ch 6 p19 §6.8 ¶15: printed "opposite directions applied" · transcribed "opposite diretions applied"
- ch 6 p21 §6.8.2 ¶3: printed "tau_i = r_i x m_i g" · transcribed "tau_i = r_i × m_i g"
- ch 6 p28 §6.11 ¶6: printed "phi_1= F_1(r_1 dtheta)sinalpha_1" · transcribed "F_1 ds_1 cos phi_1 = F_1 (r_1 dtheta) sin alpha_1"
- ch 6 p28 §6.11 ¶7: printed "tau_1= r_1F_1 sinalpha" · transcribed "tau_1 = r_1 F_1 sin alpha,"
...
- ch 3 p15 §3.10 ¶4: printed "perpendicular to r. In this limit Delta v -> 0" · transcribed "perpendicular to r. In this limit Delta v -> 0"
- ch 3 p15 §3.10 ¶4: printed "also perpendicular to V" · transcribed "also perpendicular to V"
...
- ch 5 p12 §5.9 ¶17: printed "W = - (1/2) k x_m^2 - mu m g x_m" · transcribed "W = − (1/2) k x_m^2 − mu m g x_m"
- ch 5 p12 §5.9 ¶18: printed "0.5 × 10^3 × 10" · transcribed "0.5 × 10^3 × 10"
- ch 5 p12 §5.9 ¶18: printed "x_m = (-mu m g + [mu^2 m^2 g^2 + m k v^2]^(1/2)) / k" · transcribed "x_m = (−mu m g + [mu^2 m^2 g^2 + m k v^2]^(1/2)) / k"
...
- ch 3 p15 §3.10 ¶3: transcribed "perpendicular to r" (printed "perpendicular to V")
- ch 4 p17 §4.11 ¶11: transcribed "270 – R' = 27  0.1N" (printed "270 – R' = 27 × 0.1N")
...
- ch 3 p11: "Fig. 3.15 The average acceleration for three time intervals"
...
|---|---|---|---|---|---|---|---|---|
| 1 | 84 | 84 | 81 | 3 | 0 | 0 | 2 | 94.0% |
| 2 | 53 | 53 | 53 | 0 | 0 | 0 | 2 | 96.2% |
| 3 | 101 | 101 | 97 | 3 | 0 | 1 | 3 | 93.1% |
| 4 | 139 | 139 | 136 | 2 | 0 | 1 | 2 | 96.4% |
| 5 | 128 | 128 | 124 | 4 | 0 | 0 | 3 | 94.5% |
| 6 | 281 | 281 | 274 | 7 | 0 | 0 | 3 | 96.4% |
| 7 | 106 | 106 | 106 | 0 | 0 | 0 | 0 | 100.0% |
clean for the book (PLAN D15 ✅): 856 of 892 paragraphs, 96.0%
not in the clean share, adjudicate before recording it: 85 page-level start flags, 0 numbered equations the print carries that the rows do not, 5 passages no row carries
