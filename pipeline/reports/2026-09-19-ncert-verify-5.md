...
| 1 | 9 | 6 | 2 | 7 | 0 | 0 | 0 | 0 |
| 2 | 8 | 5 | 2 | 6 | 0 | 0 | 0 | 0 |
| 3 | 16 | 10 | 5 | 14 | 0 | 0 | 0 | 1 |
| 4 | 17 | 15 | 1 | 15 | 0 | 0 | 0 | 0 |
| 5 | 15 | 12 | 2 | 15 | 0 | 0 | 0 | 0 |
| 6 | 31 | 22 | 8 | 23 | 1 | 0 | 0 | 7 |
| 7 | 12 | 6 | 5 | 6 | 0 | 0 | 0 | 1 |
...
- ch 6 p17: 12 rows start here, the print starts 11 paragraphs — rows the print does not start: §6.7.2 ¶19 "If tau_ext = 0, Eq. (6.28b) reduces" · §6.7.2 ¶24 "Answer Here r = i_hat – j_hat" · printed starts no row begins with: "remains constant throughout the motion."
...
- ch 6 p20: 12 rows start here, the print starts 11 paragraphs — rows the print does not start: §6.8 ¶19 "Answer Consider a couple as shown in" · §6.8.1 ¶1 "An ideal lever is essentially a light" · printed starts no row begins with: "Consider a couple as shown in"
...
- ch 6 p27: 6 rows start here, the print starts 8 paragraphs — rows the print does not start: §6.11 ¶3 "(1) We need to consider only those" · §6.11 ¶4 "(2) We need to consider only those" · printed starts no row begins with: "= 2π × angular speed in" · "Similarly ω = final angular speed" · "not be taken into account." · "not be taken into account."
...
- ch 6 §6.10 ¶13 runs from p26 onto p27, but p27 opens a new paragraph: "= 2π × angular speed in"
...
- ch 1 §1.6.1 ¶8 starts a paragraph at the top of p9, but the print continues p8's: "The dimensions of RHS are" — ruled noise: §1.6.1 ¶7 ends on the completed dimensional equation [M L^2 T^-2]
...
- ch 2 §2.4 ¶4 starts a paragraph at the top of p6, but the print continues p5's: "This equation can also be obtained" — ruled noise: §2.4 ¶3 ends on the display (2.8); nothing is cut at the break
- ch 3 §3.7.1 ¶1 starts a paragraph at the top of p9, but the print continues p8's: "3.7.1 Position Vector and Displacement" — ruled noise: p8 ends with the heading "3.7.1 Position Vector and Displacement" and the first paragraph after a heading is flush — the check read that flushness as a continuation
...
- ch 5 §5.3 ¶2 starts a paragraph at the top of p4, but the print continues p3's: "The work done by the force" — ruled noise: §5.3 ¶1 ends "…as shown in Fig. 5.2."; this is the page whose bold definition is set flush at the column top, which is why a flush top proves nothing
...
- ch 5 §5.11.1 ¶1 starts a paragraph at the top of p14, but the print continues p13's: "5.11.1 Elastic and Inelastic Collisions" — ruled noise: p13 ends with the heading "5.11.1 Elastic and Inelastic Collisions"; the paragraph after a heading is flush
...
| 2 | 53 | 53 | 53 | 0 | 0 | 0 | 0 | 100.0% |
| 3 | 103 | 103 | 103 | 0 | 0 | 0 | 0 | 100.0% |
| 4 | 139 | 139 | 139 | 0 | 0 | 0 | 0 | 100.0% |
| 5 | 126 | 126 | 126 | 0 | 0 | 0 | 0 | 100.0% |
| 6 | 283 | 283 | 283 | 0 | 0 | 0 | 1 | 99.6% |
| 7 | 106 | 106 | 106 | 0 | 0 | 0 | 0 | 100.0% |
clean for the book (PLAN D15 ✅): 893 of 894 paragraphs, 99.9%
not in the clean share, adjudicate before recording it: 86 page-level start flags, 0 numbered equations the print carries that the rows do not, 5 passages no row carries
