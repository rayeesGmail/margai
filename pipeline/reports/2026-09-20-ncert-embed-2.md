...
- run: 2026-09-20 12:11 IST
- input: ../pipeline/inputs/books.yaml
- sha256: 43094de04766d480a31d739fac3a7135d697568a2cc78ef7ebe587685e3b6b5c
- read: 794 paragraph(s) waiting for a vector
- result: ok
request id: pipeline-ncert-embed-aac79014-1c2f-4d1f-a308-6e1e8da9d4cf
chunk: one paragraph, its English text as loaded (§6.4)
concept queries: 15 from ../eval/retrieval-queries.json (5 in Hindi)
pacing: 90 calls/minute (margai.pipeline.embed-calls-per-minute) — about 8 min for 794 paragraphs
...
|---|---|---|---|---|
| all | 15 | 7/15 (47%) | 9/15 (60%) | 0.576 |
| english | 10 | 5/10 (50%) | 6/10 (60%) | 0.613 |
...
| q06-car-turning-flat-road | en | 5 |  | [ch 4 §4.10 ¶9, ch 4 §4.10 ¶2] | what stops a car from skidding sideways when it takes a turn on a flat road |
| q07-zero-work | en | 11 |  | [ch 5 §5.3 ¶7] | if I carry my bag across a flat room have I done any work on it |
| q08-rotational-kinetic-energy | en | 2 |  | [ch 6 §6.9 ¶6, ch 6 §6.9 ¶1] | a spinning wheel is made of many particles so what is its total kinetic energy 1/2 mv^2 for each one |
...
**q01-significant-figures** (en) — if I multiply two measured lengths how many digits should I keep in the answer
  1. phy11-part1 ch 1 §1.3 ¶1 · both · similarity 0.502 · Every measurement involves errors. Thus, the result of measurement should be reported in …
  ...
  3. phy11-part1 ch 1 §1.3 ¶21 · both · similarity 0.489 · (6) The multiplying or dividing factors which are neither rounded numbers nor numbers rep…

**q02-speed-vs-velocity** (en) — is speed the same thing as velocity or is there a difference
  1. ✅ phy11-part1 ch 2 §2.2 ¶10 · both · similarity 0.563 · Instantaneous speed or simply speed is the magnitude of velocity. For example, a velocity…
  2. phy11-part1 ch 1 §1.4 ¶5 · both · similarity 0.518 · Note that in this type of representation, the magnitudes are not considered. It is the qu…
...
**q03-displacement-vs-path** (en) — if I walk around a park and come back to where I started how much have I moved
  1. phy11-part1 ch 3 §3.7.1 ¶2 · vector · similarity 0.374 · Suppose a particle moves along the curve shown by the thick line and is at P at time t an…
...
**q04-friction-contact-area** (en) — does friction depend on how much surface area is touching
  1. ✅ phy11-part1 ch 4 §4.9.1 ¶2 · both · similarity 0.475 · We know from experience that as the applied force exceeds a certain limit, the body begin…
...
**q05-inertia-bus** (en) — why do I get thrown backwards when a bus suddenly starts moving
  1. ✅ phy11-part1 ch 4 §4.4 ¶8 · both · similarity 0.533 · The property of inertia contained in the First law is evident in many situations. Suppose…
  2. phy11-part1 ch 4 §4.4 ¶7 · both · similarity 0.293 · Consider the motion of a car starting from rest, picking up speed and then moving on a sm…
  3. phy11-part1 ch 4 §4.2 ¶4 · vector · similarity 0.315 · What is the flaw in Aristotle’s argument? The answer is: a moving toy car comes to rest b…

**q06-car-turning-flat-road** (en) — what stops a car from skidding sideways when it takes a turn on a flat road
  1. phy11-part1 ch 4 §4.10 ¶3 · both · similarity 0.386 · The circular motion of a car on a flat and banked road give interesting application of th…
  2. phy11-part1 ch 4 §4.9.1 ¶16 · both · similarity 0.364 · In many practical situations, however, friction is critically needed. Kinetic friction th…
  3. phy11-part1 ch 4 §4.10 ¶18 · both · similarity 0.366 · Answer On an unbanked road, frictional force alone can provide the centripetal force need…

**q07-zero-work** (en) — if I carry my bag across a flat room have I done any work on it
  1. phy11-part1 ch 5 §5.3 ¶3 · vector · similarity 0.384 · We see that if there is no displacement, there is no work done even if the force is large…
  2. phy11-part1 ch 5 §5.10 ¶1 · text · Often it is interesting to know not only the work done on an object, but also the rate at…
  3. phy11-part1 ch 5 §5.3 ¶5 · vector · similarity 0.370 · (i) the displacement is zero as seen in the example above. A weightlifter holding a 150 k…
...
**q08-rotational-kinetic-energy** (en) — a spinning wheel is made of many particles so what is its total kinetic energy 1/2 mv^2 for each one
  1. phy11-part1 ch 6 §6.9 ¶2 · both · similarity 0.597 · where m_i is the mass of the particle. The total kinetic energy K of the body is then giv…
  2. ✅ phy11-part1 ch 6 §6.9 ¶1 · both · similarity 0.537 · We have already mentioned that we are developing the study of rotational motion parallel …
  3. phy11-part1 ch 6 §6.11 ¶27 · both · similarity 0.523 · (c) Let omega be the final angular velocity. The kinetic energy gained = (1/2) I omega^2,…

**q09-moment-of-inertia-hi** (hi) — किसी वस्तु को घुमाना शुरू करना कितना कठिन होगा यह किन बातों पर निर्भर करता है
  1. phy11-part1 ch 4 §4.1 ¶2 · vector · similarity 0.309 · Let us first guess the answer based on our common experience. To move a football at rest,…
  2. phy11-part1 ch 4 §4.5 ¶5 · vector · similarity 0.304 · • If two stones, one light and the other heavy, are dropped from the top of a building, a…
  3. phy11-part1 ch 6 §6.1.1 ¶1 · vector · similarity 0.269 · Let us try to explore this question by taking some examples of the motion of rigid bodies…

**q10-angular-momentum-conservation** (en) — why does a skater spin faster when she pulls her arms in
  1. ✅ phy11-part1 ch 6 §6.12.1 ¶3 · both · similarity 0.389 · This then is the required form, for fixed axis rotation, of Eq. (6.29a), which expresses …
  2. phy11-part1 ch 6 §6.8.1 ¶8 · text · If the effort arm d_2 is larger than the load arm, the mechanical advantage is greater th…
  3. phy11-part1 ch 4 §4.5 ¶7 · vector · similarity 0.384 · • A seasoned cricketer catches a cricket ball coming in with great speed far more easily …

**q11-escape-speed** (en) — how fast does a rocket have to go to leave the earth for good
  1. ✅ phy11-part1 ch 7 §7.8 ¶6 · vector · similarity 0.462 · The minimum value of V_i corresponds to the case when the L.H.S. of Eq. (7.29) equals zer…
  2. phy11-part1 ch 7 §7.1 ¶1 · text · Early in our lives, we become aware of the tendency of all material objects to be attract…
  3. phy11-part1 ch 7 §7.8 ¶10 · vector · similarity 0.451 · Equation (7.32) applies equally well to an object thrown from the surface of the moon wit…
...
**q13-inertia-hi** (hi) — जड़त्व किसे कहते हैं और न्यूटन के पहले नियम से इसका क्या संबंध है
  1. ✅ phy11-part1 ch 4 §4.4 ¶2 · vector · similarity 0.406 · Newton built on Galileo’s ideas and laid the foundation of mechanics in terms of three la…
  ...
  3. phy11-part1 ch 4 §4.5 ¶1 · vector · similarity 0.347 · The first law refers to the simple case when the net external force on a body is zero. Th…

**q14-momentum-conservation-hi** (hi) — बंदूक से गोली चलाने पर बंदूक पीछे क्यों हटती है
  1. phy11-part1 ch 4 §4.5 ¶20 · vector · similarity 0.324 · Answer The retardation ‘a’ of the bullet (assumed constant) is given by a = -u^2 / 2s = (…
  ...
  3. phy11-part1 ch 5 §5.8 ¶16 · vector · similarity 0.313 · At point C, the string becomes slack and the velocity of the bob is horizontal and to the…

**q15-gravity-with-depth-hi** (hi) — पृथ्वी की सतह से नीचे जाने पर गुरुत्वीय त्वरण का मान कैसे बदलता है
  1. ✅ phy11-part1 ch 7 §7.6 ¶11 · vector · similarity 0.431 · Thus, as we go down below earth's surface, the acceleration due gravity decreases by a fa…
  2. phy11-part1 ch 7 §7.6 ¶6 · vector · similarity 0.360 · Now, consider a point mass m at a depth d below the surface of the earth (Fig. 7.8(b)), s…
  3. phy11-part1 ch 7 §7.6 ¶3 · vector · similarity 0.340 · This is clearly less than the value of g on the surface of earth : g = GM_E / R_E^2. For …
