...
- ch 2 p9: 5 rows start here, the print starts 4 paragraphs — rows the print does not start: §2.4 ¶33 "Answer The ruler drops under free fall."
...
- ch 2 §2.4 ¶32: figure_refs carries "Fig. 2.8", which no caption in chapter 2 prints
...
verifier: claude-sonnet-5 (prompt ncert_verify.v1); transcribed by: claude-opus-5 (909 rows)
request id: pipeline-ncert-verify-1dc4a4ab-31c8-4590-ad97-5eacbf7e2cf9
...
|---|---|---|
| 113 | 5 | 108 |
artefact: verify/phy11-part1/en.jsonl (113 pages)

## cost (from the ai_calls ledger)

| calls | input | output | cache read | cache write | cost |
|---|---|---|---|---|---|
| 5 | 19494 | 1120 | 29004 | 7251 | ₹6.69 |
...
clean for the book (PLAN D15 ✅): 908 of 909 paragraphs, 99.9%
not in the clean share, adjudicate before recording it: 91 page-level start flags, 0 numbered equations the print carries that the rows do not, 26 passages no row carries
