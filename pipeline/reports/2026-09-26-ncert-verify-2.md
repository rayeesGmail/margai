...
| 2 | 13 | 10 | 2 | 4 | 0 | 1 | 0 | 0 |
| 3 | 8 | 7 | 0 | 3 | 1 | 0 | 0 | 0 |
| 4 | 23 | 17 | 5 | 10 | 1 | 1 | 0 | 0 |
| 5 | 29 | 27 | 1 | 19 | 0 | 1 | 0 | 0 |
| 6 | 16 | 14 | 1 | 3 | 2 | 0 | 0 | 0 |
| 7 | 19 | 17 | 1 | 8 | 0 | 1 | 0 | 0 |
| 8 | 9 | 5 | 3 | 1 | 0 | 0 | 0 | 0 |
| 9 | 13 | 12 | 0 | 6 | 0 | 0 | 0 | 0 |
| 10 | 9 | 8 | 0 | 7 | 2 | 0 | 0 | 0 |
| 11 | 13 | 11 | 1 | 7 | 0 | 1 | 0 | 0 |
| 12 | 10 | 9 | 0 | 3 | 0 | 0 | 0 | 0 |
| 13 | 10 | 9 | 0 | 8 | 0 | 1 | 0 | 0 |
...
- ch 2 p9: 1 rows start here, the print starts 0 paragraphs — rows the print does not start: §2.4 ¶2 "The menstrual phase is followed by the"
...
- ch 3 p7: 4 rows start here, the print starts 7 paragraphs — rows the print does not start: §3.3 ¶4 "Such practices should be avoided because these" · printed starts no row begins with: "(i) Avoid sex with unknown partners/multiple" · "(ii) Always try to use condoms" · "(iii) In case of doubt, one" · "detection and get complete treatment if"
...
- ch 4 p11: 1 rows start here, the print starts 1 paragraphs — rows the print does not start: §4.2.2.2 ¶1 "Till now we were discussing crosses where" · printed starts no row begins with: "In the first case, the modified"
...
- ch 5 p28: 4 rows start here, the print starts 10 paragraphs — printed starts no row begins with: "(i) isolation of DNA," · "(ii) digestion of DNA by restriction" · "(iii) separation of DNA fragments by" · "membranes, such as nitrocellulose or nylon," · "(v) hybridisation using labelled VNTR probe," · "representation of DNA fingerprinting is shown"
...
- ch 6 p5: 1 rows start here, the print starts 0 paragraphs — rows the print does not start: §6.3 ¶4 "Such similarities can be interpreted to understand"
- ch 6 p16: 1 rows start here, the print starts 0 paragraphs — rows the print does not start: §6.9 ¶2 "Homo erectus probably ate meat. The Neanderthal"
...
- ch 11 p7: 6 rows start here, the print starts 1 paragraphs — rows the print does not start: §11.1.2 ¶8 "Growth Models : Does the growth of" · §11.1.2 ¶10 "The r in this equation is called" · §11.1.2 ¶11 "To give you some idea about the" · §11.1.2 ¶12 "The above equation describes the exponential or" · §11.1.2 ¶13 "Any species growing exponentially under unlimited resource"
- ch 11 p8: 4 rows start here, the print starts 3 paragraphs — rows the print does not start: §11.1.2 ¶14 "Darwin showed how even a slow growing" · §11.1.2 ¶15 "The king and the minister sat for" · printed starts no row begins with: "fast a huge population could build"
...
- ch 3 §3.3 ¶4 starts a paragraph at the top of p7, but the print continues p6's: "Such practices should be avoided because"
- ch 4 §4.2.2.1 ¶3 runs from p10 onto p11, but p11 opens a new paragraph: "In the first case, the modified"
- ch 6 §6.3 ¶4 starts a paragraph at the top of p5, but the print continues p4's: "Such similarities can be interpreted to"
- ch 6 §6.9 ¶2 starts a paragraph at the top of p16, but the print continues p15's: "Homo erectus probably ate meat. The"
- ch 10 §10.1 ¶1 runs from p1 onto p2, but p2 opens a new paragraph: "(ii) organic agriculture; and"
- ch 10 §10.2.1 ¶4 starts a paragraph at the top of p6, but the print continues p5's: "In mammals, including humans, insulin is"

## figure_refs against the paragraph and the chapter's captions

- ch 1 §1.4.2 ¶2: figure_refs carries "Figure 1.14a", which no caption in chapter 1 prints
- ch 1 §1.4.2 ¶3: figure_refs carries "Figure 1.14 b", which no caption in chapter 1 prints
- ch 2 §2.6 ¶1: figure_refs carries "Figure 2.12", which no caption in chapter 2 prints
- ch 4 §4.3.2 ¶5: figure_refs carries "Figure 4.10", which no caption in chapter 4 prints
- ch 5 §5.9 ¶7: figure_refs carries "Figure 5.15", which no caption in chapter 5 prints
- ch 7 §7.5 ¶5: figure_refs carries "Figure 7.11", which no caption in chapter 7 prints
- ch 11 §11.1.4 ¶2: the paragraph mentions table 11.1, which figure_refs does not carry
- ch 13 §13.1.2 ¶3: the paragraph mentions fig 13.2, which figure_refs does not carry
...
none
verifier: claude-sonnet-5 (prompt ncert_verify.v1); transcribed by: claude-opus-5 (679 rows)
request id: pipeline-ncert-verify-ca67f178-45cc-42bd-a21a-7589fca66989
...
|---|---|---|---|---|---|
| 193 | 744480 | 31247 | 1392192 | 7251 | ₹189.76 |
...
- ch 1 p11 §1.2.3 ¶2: printed "Pollination is the mechanism" · transcribed "Pollination is the mechanism to achieve this objective."
- ch 1 p12 §1.2.3 ¶6: printed "Transfer of pollen grains from anther" · transcribed "Transfer of pollen grains from anther to the stigma of a different plant"
- ch 4 p16 §4.3.2 ¶3: printed "segregating with the red chromosome" · transcribed "segregating with the red chromosomes"
- ch 4 p26 §4.8.3 ¶6: printed "one of the X chromosomes" · transcribed "one of the X chromosomes, i.e., 45 with X0, Such females"
- ch 5 p2 §5.1 ¶1: printed "phi×174" · transcribed "phi×174 has"
- ch 5 p17 §5.6 ¶2: printed "biochemist and geneticists" · transcribed "biochemists and geneticists"
- ch 5 p19 §5.6 ¶14: printed "Met-Phe-Phe-Phe-Phe-Phe" · transcribed "Met-Phe-Phe-Phe-Phe-Phe-Phe"
- ch 7 p5 §7.1 ¶5: printed "P. malariae" · transcribed "P. malaria"
- ch 7 p16 §7.4 ¶6: printed "such as α-interferon which" · transcribed "such as alpha-interferon which"
- ch 7 p16 §7.5 ¶3: printed "white, odourless, bitter crystalline" · transcribed "white, odourless, bitter crystalline compound"
- ch 8 p5 §8.2.3 ¶1: printed "Clostridium butylicum" · transcribed "Clostridium butylicum (a bacterium) of butyric acid"
- ch 8 p5 §8.2.3 ¶3: printed "commercialised as blood-cholesterol" · transcribed "commercialised as blood-cholesterol lowering agents"
- ch 9 p4 §9.1 ¶6: printed "This can also be called as cloning or" · transcribed "This can also be called as cloning or making multiple identical copies of any template DNA."
- ch 9 p7 §9.2.1 ¶6: printed "5' → 3' direction" · transcribed "5' -> 3' direction"
- ch 9 p7 §9.2.1 ¶6: printed "3' → 5' direction" · transcribed "3' -> 5' direction"
- ch 9 p11 §9.2.3 ¶2: printed "biolistics" · transcribed "biolistics or gene gun"
- ch 13 p7 §13.1.4 ¶5: printed "This is the most important" · transcribed "This is the most important cause"
...
- ch 5 p28: "(ii) digestion of DNA by restriction endonucleases,"
...
- ch 5 p28 §5.10 ¶4: printed "(iii) separation of DNA fragments by electrophoresis, (v) hybridisation using labelled VNTR probe, and" · transcribed "(iii) separation of DNA fragments by electrophoresis, (v) hybridisation using labelled VNTR probe, and"
...
|---|---|---|---|---|---|---|---|---|
| 1 | 64 | 64 | 62 | 2 | 0 | 0 | 2 | 93.8% |
| 2 | 31 | 31 | 31 | 0 | 0 | 0 | 1 | 96.8% |
| 3 | 25 | 25 | 25 | 0 | 0 | 0 | 1 | 96.0% |
| 4 | 76 | 76 | 74 | 2 | 0 | 0 | 2 | 94.7% |
| 5 | 147 | 147 | 144 | 3 | 0 | 0 | 1 | 97.3% |
| 6 | 34 | 34 | 34 | 0 | 0 | 0 | 2 | 94.1% |
| 7 | 69 | 69 | 66 | 3 | 0 | 0 | 1 | 94.2% |
| 8 | 31 | 31 | 29 | 2 | 0 | 0 | 0 | 93.5% |
| 9 | 47 | 47 | 44 | 3 | 0 | 0 | 0 | 93.6% |
| 10 | 43 | 43 | 43 | 0 | 0 | 0 | 2 | 95.3% |
| 11 | 45 | 45 | 45 | 0 | 0 | 0 | 1 | 97.8% |
| 12 | 33 | 33 | 33 | 0 | 0 | 0 | 0 | 100.0% |
| 13 | 34 | 34 | 33 | 1 | 0 | 0 | 1 | 94.1% |
clean for the book (PLAN D15 ✅): 649 of 679 paragraphs, 95.6%
not in the clean share, adjudicate before recording it: 88 page-level start flags, 0 numbered equations the print carries that the rows do not, 8 passages no row carries
