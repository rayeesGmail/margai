 ...
 * {@link NcertExtractTask} itself, so the command that spends can be driven end to end without a
...
public interface NcertPageExtractor {
     ...
     * @param previousTail the tail of the previous page's last paragraph, null for the first page
     */
