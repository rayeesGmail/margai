 ...
 * locked read for verification so concurrent guesses serialise on the row, and (D9) the bulk
 * retirement of pending codes after a start with a per-process pepper.
 */
