 ...
 * {@code storage :: api} (D14, the content bucket) and {@code ai :: tasks} (D14, the extraction
 * task — a feature module calls tasks, never the {@code AiClient} seam, §4.1).
 */
@org.springframework.modulith.ApplicationModule(
        displayName = "pipeline",
        allowedDependencies = {"common :: api", "curriculum :: api", "storage :: api", "ai :: tasks"})
